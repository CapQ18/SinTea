...
export const API = {
  ...
  blocks: (userId: number) => `${API_BASE_URL}/api/users/${userId}/block`,
  blockList: `${API_BASE_URL}/api/users/blocks`,
  blockIds: `${API_BASE_URL}/api/users/blocked-ids`,
  notifications: {
  ...
  admin: {
    ...
    reportAction: (id: number) => `${API_BASE_URL}/api/admin/reports/${id}/action`,
  },
  users: {
